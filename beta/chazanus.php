...
<html lang="en">
<head>
	<title>Davening | Bais-Mordechai.com
	</title>
...
<!--<script type="text/javascript"
	...
	$(document).ready(function(){
		...
		{title: 'Shalom Aleichem', free:true,mp3: '../mp3/chazanus/shalom aleichem.MP3'},
		{title: 'Aishes Chayil', free:true,mp3: '../mp3/chazanus/aishais chayil.MP3'},
		{title: 'Mizmor L\'Dovid', free:true,mp3: '../mp3/chazanus/mizmor l\'dovid.MP3'},
		{title: 'Kiddush', free:true,mp3: '../mp3/chazanus/kiddush.MP3'},
		{title: 'Haftorah Trop', free:true,mp3: '../mp3/chazanus/trup-haftorah.MP3'}
		], {
			playlistOptions: {
	...
	<ul>
		<li><a
			...
			<li class="divider-vertical"></li>
									...
									<li class="divider-vertical"></li>
									<li><a href="http://bais-mordechai.com/beta/chazanus.php">Chazanus</a></li>
									<li class="divider-vertical"></li>
