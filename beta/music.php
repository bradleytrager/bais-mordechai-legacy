...
<!--<script type="text/javascript"
	...
	// 	localStorage.music.clear();
	// 	localStorage.music.trackNumber = myPlaylist.current;
	// 	localStorage.music.currentTime = $("#jquery_jplayer_N").data("jPlayer").status.currentTime;
	// 	localStorage.music.src = $("#jquery_jplayer_N").data("jPlayer").status.src;
...
$(document).ready(function(){
	...
	{title: 'Maw Ashiu', free: true, mp3:'../mp3/music/Track 22.mp3'},
	{title: 'Shabbichi Yerushalyim', free: true, mp3:'../mp3/music/Track 23.mp3'},
...
// 		myPlaylist.play(parseInt(localStorage.music.trackNumber));
// 	$('#jquery_jplayer_N').jPlayer("setMedia", { // Set the media
// 		mp3: localStorage.music.src
// 	}).jPlayer("play", parseInt(Math.floor(localStorage.music.currentTime)) );
// });
// }
