...
<html lang="en">
<head>
	<title>Music | Bais-Mordechai.com
	</title>
...
<!--<script type="text/javascript"
	...
	<script type="text/javascript">
		$( window ).unload(function() {
			localStorage.clear();
			localStorage.trackNumber = myPlaylist.current;
			localStorage.currentTime = $("#jquery_jplayer_N").data("jPlayer").status.currentTime;
			localStorage.src = $("#jquery_jplayer_N").data("jPlayer").status.src;
		...
		$(document).ready(function(){
			...
			}, [{title: 'Introduction', free:true, mp3:'../mp3/music/Track 01.mp3'},
			{title: 'Ashrei Ish', free:true, mp3:'../mp3/music/Track 02.mp3'},
			{title: 'Boruch Hagever', free: true, mp3:'../mp3/music/Track 03.mp3'},
			{title: 'Ahavti', free: true, mp3:'../mp3/music/Track 04.mp3'},
			{title: 'Harachamunu', free: true, mp3:'../mp3/music/Track 05.mp3'},
			{title: 'Modeh Ani', free: true, mp3:'../mp3/music/Track 06.mp3'},
			{title: 'I Love Hashem', free: true, mp3:'../mp3/music/Track 07.mp3'},
			{title: 'Ivdu Hashem', free: true, mp3:'../mp3/music/Track 08.mp3'},
			{title: 'Ashrei Ha\'am', free: true, mp3:'../mp3/music/Track 09.mp3'},
			{title: 'Kavei Lashem', free: true, mp3:'../mp3/music/Track 10.mp3'},
			{title: 'Achos Sho\'alti', free: true, mp3:'../mp3/music/Track 11.mp3'},
			{title: 'Hodu', free: true, mp3:'../mp3/music/Track 12.mp3'},
			{title: 'Hamavdil', free: true, mp3:'../mp3/music/Track 13.mp3'},
			{title: 'Shira Lashem', free: true, mp3:'../mp3/music/Track 14.mp3'},
			{title: 'Atah Seiserli', free: true, mp3:'../mp3/music/Track 15.mp3'},
			{title: 'Ashrainu Ma Tov', free: true, mp3:'../mp3/music/Track 16.mp3'},
			{title: 'Torah Man', free: true, mp3:'../mp3/music/Track 17.mp3'},
			{title: 'Avinu Ha\'av', free: true, mp3:'../mp3/music/Track 18.mp3'},
			{title: 'Hu Yiftach', free: true, mp3:'../mp3/music/Track 19.mp3'},
			{title: 'Borei Nefashos', free: true, mp3:'../mp3/music/Track 20.mp3'},
			{title: 'Al Hamichiya', free: true, mp3:'../mp3/music/Track 21.mp3'},
			{title:'To My Wife', free:true, mp3:'../mp3/music/Track 01 1.mp3'},
			{title:'To My Son', free:true, mp3:'../mp3/music/Track 02 1.mp3'},
			{title:'To My Daughter', free:true, mp3:'../mp3/music/Track 03 1.mp3'}], {
				playlistOptions: {
...
// 	if(confirm("Would you like to continue from track " + localStorage.trackNumber + " at " + parseInt(Math.floor(localStorage.currentTime)) + 'seconds?' )){
// 		myPlaylist.play(parseInt(localStorage.trackNumber));
// 	$('#jquery_jplayer_N').jPlayer("setMedia", { // Set the media
// 		mp3: localStorage.src
// 	}).jPlayer("play", parseInt(Math.floor(localStorage.currentTime)) );
// 	}
// });
...
if(iOS && !(localStorage.currentTime == 0 && localStorage.trackNumber == 0)){
	$("#jquery_jplayer_N").bind($.jPlayer.event.ready, function() {
	$('#myModal').modal('show');
	$("#play").click(function() {
		myPlaylist.play(parseInt(localStorage.trackNumber));
	...
	$('#jquery_jplayer_N').jPlayer("pause", parseInt(Math.floor(localStorage.currentTime)) );
	$('#myModal').modal('hide');
});
});
}else{
	...
	$('#jquery_jplayer_N').jPlayer("pause", parseInt(Math.floor(localStorage.currentTime)) );
	$('#jquery_jplayer_N').jPlayer("pause", 0);
	$('#jquery_jplayer_N').jPlayer("pause", parseInt(Math.floor(localStorage.currentTime)) );

});
}
$('#message').html("Track #" + (parseInt(localStorage.trackNumber) + 1) + " at " + parseInt(Math.floor(localStorage.currentTime)) + " seconds");
...
<li><a href="#">Other Shiurim</a>
	<ul>
		<li><a
			...
			<li class="divider-vertical"></li>
			<li><a href="http://bais-mordechai.com/beta/mailing_list.php">Mailing List</a></li>
			<li class="divider-vertical"></li>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		...
		<h3 id="myModalLabel">Bais Mordechai</h3>
	</div>
	<div class="modal-body">
		<p>Would you like to resume at <span id="message"></span>?</p>
	</div>
	<div class="modal-footer">
		<button id="play" class="btn btn-primary">Yes</button>
