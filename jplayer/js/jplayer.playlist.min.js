...
//Begin hack for download
						listItem += "<a class='" + self.options.playlistOptions.freeItemClass + "' href='" + "../download.php?filename=" + value.split("../")[1] + "&title=" + media.title + "' tabindex='1'>" + "Download" + "</a>";
					}
				});
				listItem += ")</span>";
			}
			...
			listItem += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + media.title + (media.artist ? " <span class='jp-artist'>: " + media.artist + "</span>" : "") + "</a>";
			listItem += "</div></li>";
